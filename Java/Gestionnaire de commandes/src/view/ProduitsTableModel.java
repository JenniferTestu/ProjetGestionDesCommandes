...
/***
 * 
 * Cette classe permet de définir le model de la table composé de produits.
 * (C'est à dire quelles colonnes à afficher, quel type d'objet à retourner lors de la selection d'une ligne etc...)
 *
 */
public class ProduitsTableModel extends AbstractTableModel{

	private final String[] entetes = { "Id", "Nom", "Prix Unitaire", "Image"};

	public Class[] colTypes = { Integer.class, String.class, Double.class, ImageIcon.class};

	private List<Produit> listeProduits = new ArrayList<>();

	
	public ProduitsTableModel(List<Produit> listeProduits) {  
