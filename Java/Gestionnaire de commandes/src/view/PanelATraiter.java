...
/***
 * 
 * Cette classe correspond à l'onglet des commandes qui sont traitées.
 *
 */
public class PanelATraiter extends JPanel {
	...
	public PanelATraiter() {
		...
		listeCommandes = comMod.findAllNonTraitee();
		...
		btnTraite = new JButton("Trait\u00E9e");
		btnTraite.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {				
				if(c!=null){
					if(comMod.setTraite(c.getId(),true)){
		...
		add(btnTraite, "cell 0 10 3 1,alignx center,aligny center");
