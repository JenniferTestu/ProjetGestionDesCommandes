...
\begin{figure}[H]
    \begin{minipage}[c]{.46\linewidth}
        \centering
        \includegraphics[width=9cm]{Site_Accueil.png}
        \caption{Accueil du site}
    \end{minipage}
    \hfill%
    \begin{minipage}[c]{.46\linewidth}
        \centering
        \includegraphics[width=9cm]{Site_Inscrire.png}
...
\begin{figure}[H]
    \begin{minipage}[c]{.46\linewidth}
        \centering
        \includegraphics[width=9cm]{Site_Connexion.png}
        \caption{Connexion à l'espace client}
    \end{minipage}
    \hfill%
    \begin{minipage}[c]{.46\linewidth}
        \centering
        \includegraphics[width=9cm]{Site_Espace_client.png}
        \caption{Espace du client connecté}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    \begin{minipage}[c]{.46\linewidth}
        \centering
        \includegraphics[width=9cm]{Site_FAQ.png}
        \caption{Page Foire Aux Questions}
    \end{minipage}
    \hfill%
    \begin{minipage}[c]{.46\linewidth}
        \centering
        \includegraphics[width=9cm]{Site_Fiche_produit.png}
        \caption{Page de la fiche d'un produit}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    \begin{minipage}[c]{.46\linewidth}
        \centering
        \includegraphics[width=9cm]{Site_Panier.png}
        \caption{Page de l'appercu du panier}
    \end{minipage}
    \hfill%
    \begin{minipage}[c]{.46\linewidth}
        \centering
        \includegraphics[width=9cm]{Site_Coordonnes.png}
        \caption{Page des coordonnees du destinataire et payeur}
    \end{minipage}
\end{figure}
\begin{figure}[H]
    \begin{minipage}[c]{.46\linewidth}
        \centering
        \includegraphics[width=9cm]{Site_Paiement.png}
        \caption{Page du choix du mode de paiement}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    \begin{minipage}[c]{.46\linewidth}
        \centering
        \includegraphics[width=9cm]{App_A_traiter.png}
        \caption{Onglet des commandes non traité par l'entreprise}
    \end{minipage}
    \hfill%
    \begin{minipage}[c]{.46\linewidth}
        \centering
        \includegraphics[width=9cm]{App_Traitee.png}
        \caption{Onglet des commandes déjà traité par l'entreprise}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    \begin{minipage}[c]{.46\linewidth}
        \centering
        \includegraphics[width=9cm]{App_Stock.png}
        \caption{Onglet de la gestion des stocks de produit}
    \end{minipage}
    \hfill%
    \begin{minipage}[c]{.46\linewidth}
        \centering
        \includegraphics[width=9cm]{App_Gestion_produits.png}
        \caption{Onglet de gestion des produits (nom, prix, description ...)}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    \begin{minipage}[c]{.46\linewidth}
        \centering
        \includegraphics[width=9cm]{App_Gestion_fourni.png}
        \caption{Onglet de gestion du cataloque des fournisseurs de l'entreprise}
    \end{minipage}
    \hfill%
    \begin{minipage}[c]{.46\linewidth}
        \centering
        \includegraphics[width=9cm]{App_Annuaire_clients.png}
        \caption{Onglet de l'annuaire des clients de l'entreprise}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    \begin{minipage}[c]{.46\linewidth}
        \centering
        \includegraphics[width=9cm]{App_Gestion_even.png}
        \caption{Onglet de gestion des événements auxquels l'entreprise participe}
    \end{minipage}
\end{figure}
...
%%%%%%%%%%%%%%%%%
\nocite{*}
\bibliography{template_stage_L3}
